...
#ax1.legend(h1[:1]+h2+h1[1:],l1[:1]+l2+l1[1:],loc='lower center',bbox_to_anchor=(1.22, -0.01),prop={"size":9})
...
ax1.text(
    x,y,
    '$\\bf{ALICE\ ITS3}$ beam test $\\it{preliminary}$',
    fontsize=12,
    ha='center', va='top',
...
fig.savefig('vothVsThreshold.png', dpi=600)
plt.show()
